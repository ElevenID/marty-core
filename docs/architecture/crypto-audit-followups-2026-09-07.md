...
| `marty-core` | `87687b671c679972d93fabaaed3661ddf789cf82` | exact KMS-signature binding for all supported credential formats, strict rejection of small-order remote Ed25519 issuer keys, signing-free KMS issuer dependency graphs, verification-only Ed448 with explicit eMRTD selection and executable KMS+CSCA graph gates, strict Ed448 RFC 8032/SPKI regressions, role-less JOSE removal, strict public-only EC and Ed25519 SPKI decoding, strict Ed25519 verification, native and browser signature-binding regressions, bounded native proving, zeroizing ZK inputs, audited Longfellow source parity, zeroizing native/browser KDF and MAC state, exact-user authenticated OS-IPC signer agent, synchronized 0.2 release metadata, isolated lockfile updates, and final fork pins |
